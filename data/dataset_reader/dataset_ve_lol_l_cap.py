...
def main_dataset_ve_lol_l_cap(rank = 1,
                         test_path='../../data/datasets/VE-LOL-L/VE-LOL-L-Cap-Full',
                         train_path=None,
                         batch_size_train=4,
                         batch_size_test=1, 
                         verbose=False, 
    ...
    low_test_dir = os.path.join(PATH_VALID, 'VE-LOL-L-Cap-Low_test')
    normal_test_dir = os.path.join(PATH_VALID, 'VE-LOL-L-Cap-Normal_test')
    ...
    if PATH_TRAIN:
        low_train_dir = os.path.join(PATH_TRAIN, 'VE-LOL-L-Cap-Low_train')
        normal_train_dir = os.path.join(PATH_TRAIN, 'VE-LOL-L-Cap-Normal_train')

...
def main_dataset_lolblur(rank = 1,
    ...
    if PATH_TRAIN:
        paths_blur_train = [os.path.join(PATH_TRAIN, 'low_blur_noise', path) for path in os.listdir(os.path.join(PATH_TRAIN, 'low_blur_noise'))]
        paths_sharp_train = [os.path.join(PATH_TRAIN, 'high_sharp_scaled', path) for path in os.listdir(os.path.join(PATH_TRAIN, 'high_sharp_scaled'))]  
...
if __name__ == '__main__':
    train_loader, test_loader, samplers = main_dataset_lolblur()
